...
| ファイル | 内容 | フェーズ | 状態 |
|---|---|---|---|
| `docs/USAGE.md` | **取扱説明書**(想定読者=3ヶ月後の発注者)。動かす3択と手順 / 画面順の使い方 / ステータス運用 / データ保全 / トラブル対処 | — | 済 |
...
- セッション再開用ブリーフィングは `ForNext_Report.md`(**作成済み・2026-08-13**。決定と根拠データ / 実測が設計を書き換えた6箇所 / 過適合の履歴と警告 / 既知問題4件+共通根本原因 / 未着手・凍結事項 / 次のステップ)。再開時はまずこれを読む
